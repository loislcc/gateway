...
window.BMAP_AUTHENTIC_KEY = "Ctr4CyeSsmGpHr6Lwrh5bthz8wbCfm4G";
(function () {
  function ba(a) {
    throw a;
  }
  ...
  x.D.Ua = function (a, b) {
    a = x.D.$(a);
    if (a === p) return a;
    for (var c = b.split(/\s+/), d = a.className, e = " " + d + " ", f = 0, g = c.length;f < g;f++) e.indexOf(" " +
      c[f] + " ") < 0 && (d = d + (" " + c[f]));
    a.className = d;
    return a
  };
  ...
  x.D.sj = function (a, b) {
    ...
    var b = x.Tk.tO(b),
      d = a.style[b];
    if (!d) var e = c.FB[b],
      d = a.currentStyle || (x.da.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
  ...
  x.UK = function () {
    function a(a) {
      document.addEventListener && (this.element = a, this.XK = this.zk ? "touchstart" : "mousedown", this.oD =
        this.zk ? "touchmove" : "mousemove", this.nD = this.zk ? "touchend" : "mouseup", this.ph = q, this.hu =
        this.gu = 0, this.element.addEventListener(this.XK, this, q), ia.M(this.element, "mousedown", s()),
        this.handleEvent(p))
    }
    a.prototype = {
      ...
      move: function (a) {
        ...
        if (10 < Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.gu) || 10 < Math.abs(c - this.hu))
          this.ph = o
      },
      end: function (a) {
        na(a);
  ...
  x.extend(Ka.prototype, {
    ...
    hk: function (a, b, c, d) {
      ...
      if (c = c && d ? f.Ck(c, this.Xb) : this.mc) if (this.mc = new H(c.lng + a * e, c.lat - b * e), (a = f.oh(
        this.mc, this.Xb)) && g) this.Oe = a
    },
    Dg: function (a, b) {
      if (Wa(a) && (this.Vu(), this.dispatchEvent(new M("onzoomstart")), a = this.Xn(a).zoom, a !== this.Oa)) {
        ...
        c && (c = this.bc(c, this.Lc), this.hk(this.width / 2 - c.x, this.height / 2 - c.y, this.wb(c, this.Lc),
          o));
    ...
    ui: function (a) {
      a instanceof H && (this.mc = this.ie.Ck(a, this.Xb), this.Oe = H.eM(a) ? new H(a.lng, a.lat) : this.ie.oh(
        this.mc, this.Xb))
    },
    xg: function (a, b) {
      a = Math.round(a) || 0;
    ...
    Bb: function () {
      return this.ss && this.ss instanceof L ? new L(this.ss.width, this.ss.height) : new L(this.Va.clientWidth,
        this.Va.clientHeight)
    },
    Ae: function (a) {
      a && a instanceof L ? (this.ss = a, this.Va.style.width = a.width + "px", this.Va.style.height = a.height +
        "px") : this.ss = p
    },
    Ha: u("Oe"),
    fa: u("Oa"),
    ...
    QR: function (a, b) {
      for (var c = this.oa(), d = b.margins || [10, 10, 10, 10], e = b.zoomFactor || 0, f = d[1] + d[3], d = d[0] +
        d[2], g = c.$o(), i = c = c.vm();i >= g;i--) {
        var k = this.oa().yc(i);
    ...
    ct: function (a, b) {
      ...
      c = d.Ha();
      e = this.QR(d, b);
      b.margins && (d = b.margins, f = (d[1] - d[3]) / 2, d = (d[0] - d[2]) / 2, g = this.oa().yc(e), b.offset &&
        (f = b.offset.width, d = b.offset.height), c.lng += g * f, c.lat += g * d);
    ...
    Tt: function (a) {
      ...
      if (a) {
        ...
        Qa(5050, c);
        a.style && (c = b.K.gm[a.style] ? b.K.gm[a.style].backColor : b.K.gm.normal.backColor) && (this.La().style
          .backgroundColor = c)
      }
    },
    eY: function (a) {
    ...
    if (a) {
      ...
      var e = function (a) {
        a && (mb = o, setTimeout(function () {
          nb.src = z.wc + "content/images/blank.gif?" + a.src
        }, 50))
      }, f = function () {
        var a = ob.shift();
        a && e(a)
  ...
  z.sg = function (a, b) {
    ...
    switch (a) {
      ...
      case "main_domain_cdn":
        ...
        break;
      default:
        d = z.url.domain[a], "[object Array]" == Object.prototype.toString.call(d) ? (c = [], x.kc.Gb(d, function (
          a, d) {
          c[d] = z.url.proto + a + "/" + b
  ...
  function tb(a) {
    var b = $a();
    b >= a.Yz ? (Xa(a.k.va) && a.k.va(a.k.jc(1)), Xa(a.k.finish) && a.k.finish(), 0 < a.Zf.length && (b = a.Zf[0],
      b.Zf = [].concat(a.Zf.slice(1)), b.start())) : (a.xy = a.k.jc((b - a.Nu) / a.k.duration), Xa(a.k.va) && a.k
        .va(a.xy), a.FF || (a.Xr = setTimeout(function () {
          tb(a)
        }, 1E3 / a.k.Gc)))
  }
  ...
  var F = {
    ...
    $O: new L(12, 36),
    ZF: new L(13, 1),
    qa: z.ma + "content/images/",
    e3: "http://api0.map.bdimg.com/images/",
    $F: z.ma + "content/images/markers_new.png",
    YO: 24,
    ZO: 73,
    gC: {
      "\u5317\u4eac": {
  ...
  function Hb(a) {
    ...
    do c = Gb.indexOf(a.charAt(i++)), d = Gb.indexOf(a.charAt(i++)), f = Gb.indexOf(a.charAt(i++)), g = Gb.indexOf(
      a.charAt(i++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(
        c), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e)); while (i < a.length);
    return b
  }
  var M = x.lang.$y;
        ...
        function (a, b, c) {
          ...
          function k(a, b, c) {
            if (a) {
              ...
              try {
                a == P ? (N[b] = N[b] || [], N[b].unshift(c)) : a.addEventListener ? a.addEventListener(b, c, q) :
          ...
          function l(a, b, c) {
            if (a) {
              ...
              try {
                ...
                } else a.removeEventListener ? a.removeEventListener(b, c, q) : a.detachEvent && a.detachEvent(
                  "on" + b, c)
              } catch (f) { }
            }
          }
          ...
          if (!B || !B.Ko) {
            var A = b.all && a.attachEvent,
              ...
              J = {}, P = function (a) {
                ...
                } else "function" == typeof a ? a(P) : ("" + a).replace(/^(?:([\w$_]+)\.)?(\w+)$/, function (a,
                  c, d) {
                  b[0] = d;
                  t.apply(P.OF(c), b)
                })
        ...
        function (a, b, c) {
          ...
          n && (n.yh && k() < n.yh) && (c.alog("cus.on", "time", function (a) {
            ...
            if ("[object Object]" === a.toString()) {
              for (var g in a) "page" == g ? b.page = a[g] : (e = parseInt(a[g]), 0 < e && /^z_/.test(g) && (d =
                o, b[g] = e));
            ...
            var b = {}, d = q;
            "string" === typeof a && (a = [a]);
            if (a instanceof Array) for (var e = 0;e < a.length;e++) /^z_/.test(a[e]) ? (d = o, b[a[e]] = 1) :
          ...
          if (t && t.yh && k() < t.yh) {
            var A = ["Moz", "O", "ms", "Webkit"],
              ...
              J = function (a) {
                ...
                return "Promise" in a && "cast" in a.mq && "resolve" in a.mq && "reject" in a.mq && "all" in a.mq &&
                  "race" in a.mq && function () {
                    var b;
                    new a.mq(function (a) {
                      b = a
                    });
                ...
                return !!a.webkitNotifications || "Notification" in a && "permission" in a.uP &&
                  "requestPermission" in a.uP
              }, pi = function () {
                for (var b = ["webkit", "moz", "o", "ms"], c = a.requestAnimationFrame, e = 0;e < b.length && !
                  c;++e) c = a[b[e] + "RequestAnimationFrame"];
                return !!c
              }, qi = function () {
            ...
            v.M("commit", function () {
              ...
              var a = setInterval(function () {
                if ("WebP-lossy" in Mb.ii && "WebP-lossless" in Mb.ii && "WebP-alpha" in Mb.ii &&
  ...
  function oa(a, b) {
    if (/^http/.test(a)) return; /*@rh 这里判断一下，如果是调用外部资源就退出去好了 */
    if (b) {
  ...
  x.object.extend(I, {
    ...
    lK: function (a) {
      if (a && this.qL()[a]) for (var a = this.qL()[a], b = 0;b < a.length;b++) this.lK(a[b]), this.Pd.ul[a[b]] ||
        this.yN(a[b])
    },
    yN: function (a) {
    ...
    uV: function (a, b) {
      for (var c = this.Pd.Tv, d = o, e = 0, f = c.length;e < f;e++) "" == c[e].KE && (c[e].SM == a ? c[e].KE =
        b : d = q);
      d && this.WK()
    },
    WK: function () {
  ...
  function gb(a, b) {
    a && (this.Mb = a, this.ba = "spot" + gb.ba++ , b = b || {}, this.Tg = b.text || "", this.zv = b.offsets ? b.offsets
      .slice(0) : [5, 5, 5, 5], this.uJ = b.userData || p, this.Qh = b.minZoom || p, this.Ff = b.maxZoom || p)
  }
  gb.ba = 0;
  ...
  x.object.extend(Xb.prototype, {
    ...
    FD: u("dc"),
    bF: function (a) {
      for (var b = 0, c = this.dc.length;b < c;b++) this.dc[b].id == a && (r = this.dc.splice(b, 1), b-- , c =
        this.dc.length)
    },
    Ce: function () {
      var a = this;
  ...
  x.object.extend(cc.prototype, {
    ...
    removeItem: function (a) {
      if (a && "menuitem" == a.Nb) {
        for (var b = 0, c = this.ya.length;b < c;b++) this.ya[b] === a && (this.ya[b].remove(), this.ya.splice(
          b, 1), c--);
        b = 0;
    ...
    dF: function (a) {
      if (this.Ee[a]) {
        for (var b = 0, c = this.ya.length;b < c;b++) this.ya[b] && ("divider" == this.ya[b].Nb && this.ya[b]
          .Nj == a) && (this.ya.splice(b, 1), c--), this.ya[b] && ("divider" == this.ya[b].Nb && this.ya[
            b].Nj > a) && this.ya[b].Nj--;
        this.Ee.splice(a, 1)
      }
    },
  ...
  function db(a, b) {
    ...
    a && (this.Ol = new H(a.lng, a.lat), this.xl = new H(b.lng, b.lat), this.Le = a.lng, this.Xd = a.lat, this.He =
      b.lng, this.Vd = b.lat)
  }
  x.object.extend(db.prototype, {
    ...
    of: u("xl"),
    IV: function (a) {
      return !(a instanceof db) || this.xj() || a.xj() ? q : a.Le > this.Le && a.He < this.He && a.Xd > this.Xd &&
        a.Vd < this.Vd
    },
    Ha: function () {
    ...
    kt: function (a) {
      if (!(a instanceof db) || Math.max(a.Le, a.He) < Math.min(this.Le, this.He) || Math.min(a.Le, a.He) > Math.max(
        this.Le, this.He) || Math.max(a.Xd, a.Vd) < Math.min(this.Xd, this.Vd) || Math.min(a.Xd, a.Vd) > Math.max(
          this.Xd, this.Vd)) return p;
    ...
    gs: function (a) {
      return !(a instanceof H) || this.xj() ? q : a.lng >= this.Le && a.lng <= this.He && a.lat >= this.Xd && a.lat <=
        this.Vd
    },
    extend: function (a) {
      if (a instanceof H) {
  ...
  x.extend(S, {
    ...
    Eu: [75, 60, 45, 30, 15, 0],
    rP: [[1.410526172116255E-8, 8.98305509648872E-6, -1.9939833816331, 200.9824383106796, -187.2403703815547, 91.6087516669843, -
      23.38765649603339, 2.57121317296198, -0.03801003308653, 1.73379812E7], [-7.435856389565537E-9, 8.983055097726239E-6, -
        0.78625201886289, 96.32687599759846, -1.85204757529826, -59.36935905485877, 47.40033549296737, -16.50741931063887,
      ...
      6856817.37], [-1.981981304930552E-8, 8.983055099779535E-6, 0.03278182852591, 40.31678527705744, 0.65659298677277, -
        4.44255534477492, 0.85341911805263, 0.12923347998204, -0.04625736007561, 4482777.06], [3.09191371068437E-9,
      ...
      826088.5]],
    qG: [[-0.0015702102444, 111320.7020616939, 1704480524535203, -10338987376042340, 26112667856603880, -
      35149669176653700, 26595700718403920, -10725012454188240, 1800819912950474, 82.5], [8.277824516172526E-4,
      ...
      4481351.045890365, -2.339375119931662E7, 7.968221547186455E7, -1.159649932797253E8, 9.723671115602145E7, -
      4.366194633752821E7, 8477230.501135234, 52.5], [0.00220636496208, 111320.7020209128, 51751.86112841131,
    ...
    qK: function (a, b) {
      if (a && b) {
        var c = b[0] + b[1] * Math.abs(a.lng),
          ...
          d = b[2] + b[3] * d + b[4] * d * d + b[5] * d * d * d + b[6] * d * d * d * d + b[7] * d * d * d * d *
            d + b[8] * d * d * d * d * d * d,
          c = c * (0 > a.lng ? -1 : 1),
          d = d * (0 > a.lat ? -1 : 1);
        return new H(c, d)
  ...
  x.extend(S.prototype, {
    ...
    bc: function (a, b, c, d, e) {
      if (a) return a = this.Ck(a, e), b = this.yc(b), new R(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((
        c.lat - a.lat) / b + d.height / 2))
    },
    wb: function (a, b, c, d, e) {
      if (a) return b = this.yc(b), this.oh(new H(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height /
        2)), e)
    },
    yc: function (a) {
  ...
  z.We(function (a) {
    ...
    a.addEventListener("clearoverlays", function () {
      ...
      a = 0;
      for (var d = b.De.length;a < d;a++) b.De[a].enableMassClear !== q && (b.De[a].remove(), b.De[a] = p, b.De
        .splice(a, 1), a-- , d--)
    });
  ...
  x.extend(oc.prototype, {
    ...
    draw: function () {
      ...
      this.z.za = new L(-Math.round(this.z.width / 2) - Math.round(this.z.Tx), -Math.round(this.z.height / 2) -
        Math.round(this.z.Tx));
  ...
  function pc(a, b, c) {
    a && b && (this.imageUrl = a, this.size = b, a = new L(Math.floor(b.width / 2), Math.floor(b.height / 2)), c =
      c || {}, a = c.anchor || a, b = c.imageOffset || new L(0, 0), this.imageSize = c.imageSize, this.anchor = a,
  ...
  function rc(a, b, c, d) {
    a && (this.Ev = {}, this.bL = d ? !!d : q, this.Uc = [], this.x_ = a instanceof qc ? a : p, this.HI = b === j ?
      o : !!(b.indexOf("%") + 1), this.Zj = isNaN(parseFloat(b)) ? 1 : this.HI ? parseFloat(b) / 100 :
        parseFloat(b), this.II = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.II ? parseFloat(c) / 100 :
          parseFloat(c) : 0)
  };
  ...
  function yc(a, b) {
    ...
    xc() && (a === j && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype
      .toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, eb.apply(c,
        arguments), c.ea = {
          ia: a
        }, c.z = {
          shape: b.shape || vc,
  ...
  x.extend(Bc.prototype, {
    ...
    jn: function (a, b) {
      this.to[a] && (this.to[a] = new H(b.lng, b.lat), this.ia[a] = new H(b.lng, b.lat), 0 == a && !this.ia[0].nb(
        this.ia[this.ia.length - 1]) && (this.ia[this.ia.length - 1] = new H(b.lng, b.lat)), this.Eh())
    },
    te: function () {
      var a = this.to;
  ...
  x.extend(Dc.prototype, {
    ...
    hv: function (a, b) {
      ...
      for (var c = [], d = b / 6378800, e = Math.PI / 180 * a.lat, f = Math.PI / 180 * a.lng, g = 0;360 > g;g +=
        9) {
        var i = Math.PI / 180 * g,
          k = Math.asin(Math.sin(e) * Math.cos(d) + Math.cos(e) * Math.sin(d) * Math.cos(i)),
          i = new H(((f - Math.atan2(Math.sin(i) * Math.sin(d) * Math.cos(e), Math.cos(d) - Math.sin(e) *
            Math.sin(k)) + Math.PI) % (2 * Math.PI) - Math.PI) * (180 / Math.PI), k * (180 / Math.PI));
        c.push(i)
      }
      d = c[0];
  ...
  x.extend(Fc.prototype, {
    ...
    Cm: function (a, b, c) {
      ...
      for (d = this.Qc.length;l < d;l++) {
        ...
        i = this.Qc[l][1];
        w = 0;
        for (m = this.Me.length;w < m;w++) if (n = this.Me[w], n.id == k + "_" + b + "_" + A + "_" + i + "_" +
          f) {
          n.kr = o;
          this.Tm[n.id] = n;
          break
      ...
      l = 0;
      for (d = this.Qc.length;l < d;l++) A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] - c / 2, v = (-
        1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.Tm[y], n = p, m ?
          (n = m.style, n.left = t + "px", n.top = v + "px", m.af || this.qn.push([A, i, m])) : (0 < this.Ne.length ?
            (m = this.Ne.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m =
              document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height =
              e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute(
                "height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") &&
            (t = "#F3F1EC", this.map.K.Co && (t = this.map.K.Co), n.background = t ? t : ""), this.qn.push([A,
              i, m])), m.style.visibility = "";
      l = 0;
    ...
    m_: function (a, b, c, d) {
      ...
      k && k.Ib ? (ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.K.xe ? this.map.K.xe.style : "normal",
        d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k, function () {
          e.yf()
        })) : (k = this.dj[g]) && k.Ib ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild), this.vg[g] = k, ub(k.Ib, b), d &&
          (d = new R(a[0], a[1]), f = this.map.K.xe ? this.map.K.xe.style : "normal", d = c.getTilesUrl(d, a[2],
            f), k.loaded = q, Ic(k, d)), k.loaded ? this.yf() : Jc(k, function () {
              e.yf()
            })) : (k = i * Math.pow(2, f.vm() - a[2]), new H(a[0] * k, a[1] * k), d = new R(a[0], a[1]), f = this.map.K
              .xe ? this.map.K.xe.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new Kc(this, d, b, a, c), Jc(k, function () {
                e.yf()
              }), k.bo(), this.vg[g] = k)
    },
    yf: function () {
    ...
    XD: function (a, b) {
      return this.map.oa() === Pa ? "TILE-" + b.ba + "-" + this.map.Hw + "-" + a[0] + "-" + a[1] + "-" + a[2] :
    ...
    qV: function (a, b) {
      for (var c = 256 * Math.pow(2, 18 - b), d = Math.floor(this.kI / c), e = Math.floor(this.lI / c), c = Math.floor(
        this.PA / c), f = [], g = 0;g < a.length;g++) {
        var i = a[g],
          k = i[0],
          i = i[1];
        if (k >= d) {
    ...
    oI: function (a) {
      ...
      for (var g = 0;g < c;g++) {
        ...
        if (i.zw) {
          ...
          if (a) {
            var l = k;
            if (l && l.childNodes) for (var m = l.childNodes.length, n = m - 1;0 <= n;n--) m = l.childNodes[
              n], l.removeChild(m), m = p
          }
          if (this.map.Wb()) {
            ...
            continue
          } else k.style.display = "block", this.ld.style.display = "none", this.map.dispatchEvent(new M(
            "vectorchanged"), {
              isvector: q
            })
        }
        if (!i.bI && !(i.rp && !this.map.Wb() || i.lM && this.map.Wb())) {
          ...
          i.Rb && (i.Rb.style.left = Math.ceil(w + B) - t[0] + "px", i.Rb.style.top = Math.ceil(y + E) - t[1] +
            "px", i.Rb.style.WebkitTransform = "translate3d(0,0,0)");
          w = [];
          for (d.MB = [];n < v;n++) for (y = l;y < e;y++) w.push([n, y]), d.MB.push({
            x: n,
            y: y
          });
    ...
    xh: function (a) {
      ...
      if (a instanceof bb) b && a.Jm && (a.remove(), a.Jm = q);
        ...
        if (a.rp) for (var b = 0, c = this.Cg.length;b < c;b++) a == this.Cg[b] && this.Cg.splice(b, 1);
        else {
          b = 0;
    ...
    Tt: function (a) {
      var b = this.map.oa();
      if (!this.map.Wb() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a)) for (var c = p, c = "2" == z.Qy ? [z.url
        .proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn
          .baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z
            .url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e;e = this.Nm[d];d++) if (e.h_ == o) {
              b.k.$b = 18;
              e.getTilesUrl = function (b, d) {
                var e = b.x,
                  ...
                  m = 1;
                this.map.Ix() && (m = 2);
                l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=" + l + "&scale=" + m +
                  "&ak=" + pa;
    ...
    this.Ib.onload = function () {
      ...
      if (g.Qm) {
        ...
        if (g.Ib && !wb(g.Ib) && e.Rb) {
          ...
          if (x.da.la <= 6 && x.da.la > 0 && g.rJ) g.Ib.style.cssText = g.Ib.style.cssText + (
  ...
  Kc.prototype.bo = function () {
    this.Ib.src = 0 < x.da.la && 6 >= x.da.la && this.rJ ? F.qa + "blank.gif" : "" !== this.src && this.Ib.src ==
  ...
  x.extend(Gc.prototype, {
    ...
    getTilesUrl: function (a, b) {
      ...
      var d = "";
      this.rh.tileUrlTemplate && (d = this.rh.tileUrlTemplate.replace(/\{X\}/, c), d = d.replace(/\{Y\}/, a.y), d =
        d.replace(/\{Z\}/, b));
      return d
    },
    sm: u("KV"),
  ...
  function bb(a) {
    this.oV = [z.url.proto + z.url.domain.TILE_ONLINE_URLS[1] + "/gvd/?", z.url.proto + z.url.domain.TILE_ONLINE_URLS[
      2] + "/gvd/?", z.url.proto + z.url.domain.TILE_ONLINE_URLS[3] + "/gvd/?", z.url.proto + z.url.domain.TILE_ONLINE_URLS[
      4] + "/gvd/?"];
    this.k = {
      aL: q
    };
  ...
  var Rc = [z.url.proto + z.url.domain.TILES_YUN_HOST[0] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[
    1] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[2] + "/georender/gss", z.url.proto + z.url
  ...
  lb.prototype.getTilesUrl = function (a, b) {
    var c = a.x,
      d = a.y,
      e = this.pc,
      c = Rc[Math.abs(c + d) % Rc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Zm + "&tags=" + e
        .ju + "&filter=" + e.filter + "&sortby=" + e.Jy + "&ak=" + this.pc.Vl + "&age=" + e.ww + "&page_size=" +
        e.vN + "&format=" + e.C_;
  ...
  var Vc = [z.url.proto + z.url.domain.TILE_BASE_URLS[0] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[1] +
    "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[2] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[3] +
  "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[4] + "/it/"],
    Wc = [z.url.proto + z.url.domain.TILE_ONLINE_URLS[0] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[1] +
      "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[2] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[
      3] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[4] + "/tile/"],
    Xc = {
      dark: "dl",
      light: "ll",
      normal: "pl"
  ...
  Yc.h_ = o;
  Yc.getTilesUrl = function (a, b, c) {   //@rh 改用本地的瓦片图
    var d = a.x,
      a = a.y,
      e = Qb("normal"),
      f = 1;
    ...
    return (Wc[Math.abs(d + a) % Wc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(
      /-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + f + (6 == x.da.la ? "&color_dep=32&colors=50" : "") +
      "&udt=" + e).replace(/-(\d+)/gi, "M$1")
  };
  var La = new Uc("\u5730\u56fe", Yc, {
    tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
    maxZoom: 19
    ...
    Zc = new Gc;
  Zc.qO = [z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[
    1] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", z.url.proto +
    z.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
  Zc.getTilesUrl = function (a, b) {
    var c = a.x,
      d = a.y,
      e = 256 * Math.pow(2, 20 - b),
      d = Math.round((9998336 - e * d) / e) - 1;
    return url = this.qO[Math.abs(c + d) % this.qO.length] + this.map.Xb + "/" + this.map.Hw + "/3/lv" + (21 - b) +
      "/" + c + "," + d + ".jpg"
  };
  var Pa = new Uc("\u4e09\u7ef4", Zc, {
    tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
  ...
  $c.getTilesUrl = function (a, b) {
    var c = a.x,
      d = a.y;
    return (Vc[Math.abs(c + d) % Vc.length] + "u=x=" + c + ";y=" + d + ";z=" + b + ";v=009;type=sate&fm=46&udt=" +
      Qb("satellite")).replace(/-(\d+)/gi, "M$1")
  };
  var Ya = new Uc("\u536b\u661f", $c, {
    tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
    minZoom: 1,
  ...
  ad.getTilesUrl = function (a, b) {
    ...
    return (Wc[Math.abs(c + d) % Wc.length] + "?qt=vtile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (d + "").replace(
      /-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == x.da.la ? "&color_dep=32&colors=50" : "") + "&udt=" + e).replace(
        /-(\d+)/gi, "M$1")
  };
  ...
  function W(a, b) {
    ...
    this.k.ka.Xg = "undefined" != typeof b && "undefined" != typeof b.renderOptions && "undefined" != typeof b.renderOptions
      .autoViewport ? b.renderOptions.autoViewport : o;
  ...
  x.extend(td.prototype, {
    ...
    SV: function () {
        ...
        if (this.page >= this.Vf) {
          ...
          a.push(
            '<span style="margin-right:3px"><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp1}">\u9996\u9875</a></span>'
              .replace("{temp1}", "BMap.I('" + this.ba + "').toPage(1);"))
        }
        a.push(
          '<span style="margin-right:3px"><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp2}">\u4e0a\u4e00\u9875</a></span>'
            .replace("{temp2}", "BMap.I('" + this.ba + "').toPage(" + b + ");"))
      }
      if (this.page < this.Vf) d = 0 == this.page % this.Vf ? this.page - this.Vf - 1 : this.page - this.page %
        this.Vf + 1, b = d + this.Vf - 1;
      else {
      ...
      for (e = d;e <= b;e++) 0 < e && (e == this.page ? a.push('<span style="margin-right:3px">' + e +
        "</span>") : 1 <= e && e <= this.Jd && (d =
          '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' + e +
          "]</a></span>", a.push(d.replace("{temp3}", "BMap.I('" + this.ba + "').toPage(" + e + ");"))));
      c > this.Jd || a.push(
        '<span><a style="color:#7777cc" href="javascript:void(0)" onclick="{temp4}">\u4e0b\u4e00\u9875</a></span>'
          .replace("{temp4}", "BMap.I('" + this.ba + "').toPage(" + c + ");"));
      a.push("</p>");
      return a.join("")
    },
    toPage: function (a) {
  ...
  function ab(a, b) {
    ...
    "undefined" != typeof b.renderOptions.selectFirstResult && !b.renderOptions.selectFirstResult ? this.LC() :
      this.hD();
    this.wa = [];
    this.wf = [];
    this.kb = -1;
  ...
  function Na(a, b) {
    function c() {
      e.k.visible ? ("inter" === e.Je && e.k.haveBreakId && e.k.indoorExitControl === o ? x.D.show(e.wA) : x.D.U(
        e.wA), this.k.closeControl && this.zf && this.C && this.C.La() === this.B ? x.D.show(e.zf) : x.D.U(e.zf),
        this.k.forceCloseControl && x.D.show(e.zf)) : (x.D.U(e.zf), x.D.U(e.wA))
    }
    ...
    this.Pg = [];
    this.zr = [];
    "cvsRender" == this.ck || Ma() ? (this.Vj = 90, this.Xj = -90) : "cssRender" == this.ck && (this.Vj = 45, this.Xj = -
      45);
    this.Dr = q;
    var e = this;
    this.bo = function () {
  ...
  x.extend(Na.prototype, {
    ...
    rc: function (a, b, c) {
      ...
      a != this.Ya && (this.rl = this.Ya, this.sl = this.Mb, this.Ya = a, this.Je = b || "street", this.Mb = p, c &&
        c.pov && this.Mc(c.pov))
    },
    ta: function (a) {
    ...
    Mc: function (a) {
      a && (this.Da = a, a = this.Da.pitch, a > this.Vj ? a = this.Vj : a < this.Xj && (a = this.Xj), this.Dr = o,
        this.Da.pitch = a)
    },
    c_: function (a, b) {
      this.Xj = 0 <= a ? 0 : a;
    ...
    Nc: function (a) {
      a != this.Jc && (a > Md && (a = Md), a < Nd && (a = Nd), a != this.Jc && (this.Jc = a), "cssRender" ===
        this.ck && this.Mc(this.Da))
    },
    wB: function () {
      if (this.C) for (var a = this.C.wx(), b = 0;b < a.length;b++)(a[b] instanceof U || a[b] instanceof tc) &&
        a[b].point && this.wa.push(a[b])
    },
    tF: ca("C"),
    Vt: function (a) {
      this.Mf = a || "none"
    ...
    er: function () {
      return Ua() && !G() && "javascript" !== this.k.panoramaRenderer ? "flashRender" : !G() && Kb() ?
        "cvsRender" : "cssRender"
    },
    Ka: function (a) {
      this.Ie[a.hd] = a
          ...
          if (a.id != b.Yv) {
            ...
            if (b.sl) {
              ...
              var i = g.lat,
                k = Nb(i - c),
                f = Nb(g.lng - f.lng);
              c = Math.sin(k / 2) * Math.sin(k / 2) + Math.cos(Nb(c)) * Math.cos(Nb(i)) * Math.sin(f / 2) *
                Math.sin(f / 2);
  ...
  ac.prototype.getTilesUrl = function (a, b) {
    var c = ac.zG[(a.x + a.y) % ac.zG.length] + "?udt=20150114&qt=tile&styles=pl&x=" + a.x + "&y=" + a.y + "&z=" +
      b;
  ...
  x.extend(ae, {
    ...
    fS: function (a, b, c, d) {
      var c = c || "",
        e;
      !d || !a.split(d)[0] ? (d = a, a = "") : (d = a.split(d)[0], e = d.lastIndexOf("<"), d = a.substring(0, e),
        a = a.substring(e));
      e = [];
      var f = ae.Du.width,
        g = ae.Du.height;
      ...
      e.push("<div id='infoWndPano' class='panoInfoBox' style='height:" + g + "px;width:" + f +
        "px; margin-top: -19px;'>");
      e.push("<img class='pano_thumnail_img' width='" + f + "' height='" + g + "' border='0' alt='" + c +
        "\u5916\u666f' title='" + c + "\u5916\u666f' src='" + b +
  ...
  var be = document,
    ...
    ee;
  a: {
    for (var fe = ["t", "webkitT", "MozT", "msT", "OT"], ge, he = 0, ie = fe.length;he < ie;he++) if (ge = fe[he] +
      "ransform", ge in de) {
  ...
  var je = ee ? "-" + ee.toLowerCase() + "-" : "",
    ...
    Je = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window
      .oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
        return setTimeout(a, 1)
      }, Ke = window.cancelRequestAnimationFrame || window.M4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window
  ...
  function Me(a, b) {
    ...
    c.options.Vk ? c.Pb.style[le] = "translate(" + c.x + "px," + c.y + "px)" + Le : c.Pb.style.cssText +=
    ...
    this.options.Cx && (Event.prototype.stopImmediatePropagation || (document.body.removeEventListener = function (
      a, b, c) {
  ...
  Me.prototype = {
    ...
    tQ: function () {
      !this.ph && (!this.Yk && !(this.Yl || this.yy == this.Pb.offsetWidth * this.scale && this.Lp == this.Pb.offsetHeight *
        this.scale)) && this.refresh()
    },
    Iv: function (a) {
      var b;
      this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = be.createElement("div"), this.options.kF ? b.className =
        this.options.kF + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ?
          "height:7px;bottom:1px;left:2px;right:" + (this.Bi ? "7" : "2") + "px" : "width:7px;bottom:" + (this.mi ?
            "7" : "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + je +
            "transition-property:opacity;" + je + "transition-duration:" + (this.options.FW ? "350ms" : "0") +
            ";overflow:hidden;opacity:" + (this.options.Gx ? "0" : "1"), this.yn.appendChild(b), this[a +
            "ScrollbarWrapper"] = b, b = be.createElement("div"), this.options.kF || (b.style.cssText =
              "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + je +
              "background-clip:padding-box;" + je + "box-sizing:border-box;" + ("h" == a ? "height:100%" :
                "width:100%") + ";" + je + "border-radius:3px;border-radius:3px"), b.style.cssText +=
        ";pointer-events:none;" + je + "transition-property:" + je + "transform;" + je +
        "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + je + "transition-duration:0;" + je +
        "transform: translate(0,0)" + Le, this.options.Ai && (b.style.cssText += ";" + je +
          "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(
            b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.NL = this.OL.clientWidth, this.UX = ce.max(ce
              .round(this.NL * this.NL / this.yy), 8), this.TX.style.width = this.UX + "px") : (this.MO = this.NO.clientHeight,
                this.a0 = ce.max(ce.round(this.MO * this.MO / this.Lp), 8), this.$_.style.height = this.a0 + "px"),
        this.qB(a, o)) : this[a + "ScrollbarWrapper"] && (Be && (this[a + "ScrollbarIndicator"].style[le] = ""),
          this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a +
          "ScrollbarWrapper"] = p, this[a + "ScrollbarIndicator"] = p)
    },
    pB: function () {
      var a = this;
      setTimeout(function () {
    ...
    Cr: function (a, b) {
      this.Yk || (a = this.kp ? a : 0, b = this.wn ? b : 0, this.options.Vk ? this.Pb.style[le] = "translate(" +
        a + "px," + b + "px) scale(" + this.scale + ")" + Le : (a = ce.round(a), b = ce.round(b), this.Pb.style
          .left = a + "px", this.Pb.style.top = b + "px"), this.x = a, this.y = b, this.qB("h"), this.qB("v"))
    },
    qB: function (a, b) {
      var c = "h" == a ? this.x : this.y;
      this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.rD || (c = this[a +
        "ScrollbarIndicatorSize"] + ce.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" ==
          a ? "width" : "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.rD ?
            c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - ce.round(3 * (c - this[a +
        ...
        this[a + "ScrollbarWrapper"].style[we] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options
          .Gx ? "0" : "1", this[a + "ScrollbarIndicator"].style[le] = "translate(" + ("h" == a ? c + "px,0)" :
            "0," + c + "px)") + Le)
    },
    EQ: function (a) {
      ...
      if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() :
        a.lZ = o, a.stopPropagation(), a.preventDefault(), this.fx = this.OB = p, q
    },
    Rv: function (a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom && (Ae && 1 < a.touches.length) && (d = ce.abs(a.touches[0].pageX - a.touches[1].pageX),
          c = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.I_ = ce.sqrt(d * d + c * c), this.gy = ce
            .abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.VF) / 2 - this.x, this.hy = ce.abs(a.touches[
              0].pageY + a.touches[1].pageY - 2 * this.WF) / 2 - this.y, this.options.Bp && this.options.Bp.call(
                this, a));
        if (this.options.Yx && (this.options.Vk ? (c = getComputedStyle(this.Pb, p)[le].replace(/[^0-9\-.,]/g,
          "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Pb, p).left
            .replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, "")), d != this
              .x || c != this.y)) this.options.Ai ? this.Yd(Ie) : Ke(this.WB), this.Aj = [], this.Cr(d, c), this.options
                .ey && this.options.ey.call(this);
        this.lw = this.x;
        this.mw = this.y;
        this.gu = this.x;
        this.hu = this.y;
    ...
    cT: function (a) {
      ...
      if (this.options.zoom && Ae && 1 < a.touches.length) e = ce.abs(a.touches[0].pageX - a.touches[1].pageX), f =
        ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.H_ = ce.sqrt(e * e + f * f), this.Yk = o, b =
        1 / this.I_ * this.H_ * this.scale, b < this.options.Xk ? b = 0.5 * this.options.Xk * Math.pow(2, b /
          this.options.Xk) : b > this.options.bq && (b = 2 * this.options.bq * Math.pow(0.5, this.options.bq /
            b)), this.vp = b / this.scale, e = this.gy - this.gy * this.vp + this.x, f = this.hy - this.hy *
            this.vp + this.y, this.Pb.style[le] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Le,
        this.options.nN && this.options.nN.call(this, a);
      else {
        this.th = b.pageX;
        this.uh = b.pageY;
        if (0 < e || e < this.he) e = this.options.Eo ? this.x + c / 2 : 0 <= e || 0 <= this.he ? 0 : this.he;
        if (f > this.rf || f < this.nd) f = this.options.Eo ? this.y + d / 2 : f >= this.rf || 0 <= this.nd ?
          this.rf : this.nd;
        this.NC += c;
        this.OC += d;
        this.jw = ce.abs(this.NC);
        this.kw = ce.abs(this.OC);
        6 > this.jw && 6 > this.kw || (this.options.DE && (this.jw > this.kw + 5 ? (f = this.y, d = 0) : this.kw >
          this.jw + 5 && (e = this.x, c = 0)), this.ph = o, this.Cr(e, f), this.HC = 0 < c ? -1 : 0 > c ? 1 :
            0, this.IC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g - this.startTime && (this.startTime = g, this.gu =
              this.x, this.hu = this.y), this.options.kN && this.options.kN.call(this, a))
      }
    },
    cv: function (a) {
      if (!(Ae && 0 !== a.touches.length)) {
        ...
        if (b.Yk) d = b.scale * b.vp, d = Math.max(b.options.Xk, d), d = Math.min(b.options.bq, d), b.vp = d /
          b.scale, b.scale = d, b.x = b.gy - b.gy * b.vp + b.x, b.y = b.hy - b.hy * b.vp + b.y, b.Pb.style[
          oe] = "200ms", b.Pb.style[le] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" +
          Le, b.Yk = q, b.refresh(), b.options.Ap && b.options.Ap.call(b, a);
        else {
          if (b.ph) {
            if (300 > i && b.options.Yx) {
              f = d ? b.nI(d - b.gu, i, -b.x, b.yy - b.vu + b.x, b.options.Eo ? b.vu : 0) : f;
              g = e ? b.nI(e - b.hu, i, -b.y, 0 > b.nd ? b.Lp - b.zn + b.y - b.rf : 0, b.options.Eo ? b.zn :
                0) : g;
              d = b.x + f.Ba;
              e = b.y + g.Ba;
            ...
            f.Ba || g.Ba ? (c = ce.max(ce.max(f.time, g.time), 10), b.options.du && (f = d - b.lw, g = e -
              b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) :
                (f = b.hJ(d, e), d = f.x, e = f.y, c = ce.max(f.time, c))), b.scrollTo(ce.round(d), ce.round(
                  e), c)) : b.options.du ? (f = d - b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) <
                    b.options.Iy ? b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(b.x, b.y), (f.x != b.x || f.y != b.y) &&
                      b.scrollTo(f.x, f.y, f.time))) : b.ko(200)
          } else {
            if (Ae) if (b.GK && b.options.zoom) clearTimeout(b.GK), b.GK = p, b.options.Bp && b.options.Bp.call(
              b, a), b.zoom(b.th, b.uh, 1 == b.scale ? b.options.mW : 1), b.options.Ap &&
              setTimeout(function () {
              ...
              "select" != e && "input" != e && "textarea" != e ? (e = be.createEvent("MouseEvents"), e.initMouseEvent(
                "click", o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey,
                a.shiftKey, a.metaKey, 0, p), e.AR = o, d.dispatchEvent(e)) : d.focus()
            }
            b.ko(400)
          }
    ...
    ko: function (a) {
      ...
      if (b == this.x && c == this.y) {
        if (this.ph && (this.ph = q, this.options.ey && this.options.ey.call(this)), this.mi && this.options.Gx &&
          ("webkit" == ee && (this.OL.style[we] = "300ms"), this.OL.style.opacity = "0"), this.Bi && this.options
            .Gx) "webkit" == ee && (this.NO.style[we] = "300ms"), this.NO.style.opacity = "0"
    ...
    GU: function (a) {
      ...
      if ("wheelDeltaX" in a) c = a.wheelDeltaX / 12, d = a.wheelDeltaY / 12;
        ...
        if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Xk && (d = b.options.Xk),
          d > b.options.bq && (d = b.options.bq), d != b.scale) !b.Sy && b.options.Bp && b.options.Bp.call(b,
            a), b.Sy++ , b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function () {
              b.Sy--;
              !b.Sy && b.options.Ap && b.options.Ap.call(b, a)
            }, 400)
      } else c = b.x + c, d = b.y + d, 0 < c ? c = 0 : c < b.he && (c = b.he), d > b.rf ? d = b.rf : d < b.nd &&
        (d = b.nd), 0 > b.nd && b.scrollTo(c, d, 0)
    },
    CU: function (a) {
    ...
    CB: function () {
      var a = this,
        ...
        d = Date.now(),
        e, f, g;
      a.Yl || (a.Aj.length ? (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Yl = o, a.ph = o, a.options
        .Ai) ? (a.qJ(e.time), a.Cr(e.x, e.y), a.Yl = q, e.time ? a.ca(Ie) : a.ko(0)) : (g = function () {
          var i = Date.now(),
            k;
          if (i >= d + e.time) {
            a.Cr(e.x, e.y);
    ...
    nI: function (a, b, c, d, e) {
      var b = ce.abs(a) / b,
        f = b * b / 0.0012;
      0 < a && f > c ? (c += e / (6 / (6.0E-4 * (f / b))), b = b * c / f, f = c) : 0 > a && f > d && (d += e / (6 /
        (6.0E-4 * (f / b))), b = b * d / f, f = d);
      return {
        Ba: f * (0 > a ? -1 : 1),
    ...
    refresh: function () {
      ...
      if ("string" == typeof this.options.du) {
        ...
        a = 0;
        for (b = c.length;a < b;a++) d = this.Zj(c[a]), d.left += this.VF, d.top += this.WF, this.Ue[a] = d.left <
          this.he ? this.he : d.left * this.scale, this.uf[a] = d.top < this.nd ? this.nd : d.top * this.scale
      } else if (this.options.du) {
        for (this.Ue = [];d >= this.he;) this.Ue[b] = d, d -= this.vu, b++;
        this.he % this.vu && (this.Ue[this.Ue.length] = this.he - this.Ue[this.Ue.length - 1] + this.Ue[this.Ue
          .length - 1]);
        b = d = 0;
        for (this.uf = [];d >= this.nd;) this.uf[b] = d, d -= this.zn, b++;
        this.nd % this.zn && (this.uf[this.uf.length] = this.nd - this.uf[this.uf.length - 1] + this.uf[this.uf
          .length - 1])
      }
      this.Iv("h");
      this.Iv("v");
    ...
    zoom: function (a, b, c, d) {
      var e = c / this.scale;
      this.options.Vk && (this.Yk = o, d = d === j ? 200 : d, a = a - this.VF - this.x, b = b - this.WF - this.y,
        this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 <
          this.x ? 0 : this.x < this.he ? this.he : this.x, this.y = this.y > this.rf ? this.rf : this.y < this.nd ?
            this.nd : this.y, this.Pb.style[oe] = d + "ms", this.Pb.style[le] = "translate(" + this.x + "px," +
            this.y + "px) scale(" + c + ")" + Le, this.Yk = q)
    }
  };
  ...
  z.Vm(function (a) {
    ...
    a.addEventListener("visible_changed", function () {
      b && (a.$D() ? a.k.albumsControl === o && (b.B.style.visibility = "visible") : b.B.style.visibility =
        "hidden")
    })
  });
  var Oe = 1.8;
  ...
  x.extend(Ne.prototype, {
    ...
    qy: function (a, b) {
      if (b || !this.$j[this.Xc] || !(this.$j[this.Xc].panoId == a && 3 !== this.$j[this.Xc].recoType)) {
        ...
        !b && -1 !== d && this.$j[d] && 3 !== this.$j[d].recoType ? this.Pp(d) : this.zX(function (a) {
          for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length;m < n;m++) d = a[m].catlog, i = a[m].floor,
            j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Pe[d]] ||
              (b[Pe[d]] = []), b[Pe[d]].push(a[m])));
    ...
    TV: function () {
      if (!this.Ki) {
        var a = this.nX(this.Ni),
          b = K("div");
        b.style.cssText = ["width:" + 134 * this.Ni.length + "px;",
        ...
        for (var c = this, d = b.getElementsByTagName("span"), e = 0, f = d.length;e < f;e++) b = d[e], x.M(b,
          "click", function () {
      ...
      if (this.Ki) a = this.lL(this.Ni), this.sQ.innerHTML = a;
        ...
        x.M(b, "click", function (a) {
          if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
            c.Gl(c.VG[a]);
            for (var d = b.getElementsByTagName("li"), e = 0, f = d.length;e < f;e++) d[e].childNodes[0].getAttribute(
              "dataindex") === a ? x.D.Ua(d[e], "pano_catlogLiActive") : x.D.Tb(d[e],
                "pano_catlogLiActive")
          }
        });
        var a = K("div"),
          ...
          f = K("a"),
          g = K("span"),
          i = ["background:url(" + F.qa + "panorama/catlog_icon.png) no-repeat;",
        ...
        a.appendChild(f);
        d = K("div");
        d.style.cssText = ["position:absolute;z-index:2001;left:20px;", "height:" + this.k.imageHeight + "px;",
    ...
    Gl: function (a) {
      this.$j = a;
      this.k.showCatalog && (0 < this.Ni.length ? (Ua() ? this.QV() : this.TV(), this.Oc.offsetLeft = 60) : (this
        .Ls && (this.B.removeChild(this.Ls), this.Ls = p, this.Oc.fg.style.left = "0px"), this.Ki && (this.B.removeChild(
          this.Ki), this.Ki = p), this.Oc.offsetLeft = 0));
      var b = this.hX(a);
      Ua() && (this.Ni && 0 < this.Ni.length && this.k.showExit && this.Zz) && (this.Oc.offsetLeft += this.eg.width +
        8, this.Ls ? this.Ls.innerHTML = this.Zz : this.RV());
      this.Wh.innerHTML = b;
      this.Wh.style.width = (this.eg.width + 8) * a.length + 8 + "px";
      a = this.B.offsetWidth;
      b = this.Wh.offsetWidth;
      this.Oc.Ss && (b += this.Oc.Ss());
      b < a - 2 * this.Oc.Ei - this.Oc.offsetLeft ? this.B.style.width = b + this.Oc.offsetLeft + "px" : (this.B.style
        .width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth + "px", b < this.B.offsetWidth -
        2 * this.Oc.Ei - this.Oc.offsetLeft && (this.B.style.width = b + this.Oc.offsetLeft + "px"));
      this.Oc.refresh();
    ...
    nX: function (a) {
      for (var b = "", c, d = 0, e = a.length;d < e;d++) c =
        ...
        a[d].index + '">' + a[d].data + "</span></div>", b += c;
      return b
    },
    lL: function (a) {
      for (var b = "", c, d = 0, e = a.length;d < e;d++) c =
        '<li class="pano_catlogLi"><span style="display:block;width:100%;" dataIndex="' + a[d].index + '">' +
        a[d].data + "</span></li>", b += c;
      return b
    },
    hX: function (a) {
      for (var b, c, d, e, f = [], g = this.eg.height, i = this.eg.width, k = 0;k < a.length;k++) b = a[k],
        recoType = b.recoType, d = b.panoId, e = b.name, c = b.heading, b = b.pitch, c = ae.xL(d, c, b, 198,
          108), b = '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k +
          '"><img style="width:' + (i - 2) + "px;height:" + (g - 2) + 'px;" data-index="' + k + '" name="' +
          e + '" src="' + c + '" alt="' + e + '"/><span class="pano_photo_decs" data-index="' + k +
          '" style="width:' + i + "px;font-size:" + Math.floor(g / 6) + "px; line-height:" + Math.floor(g / 6) +
          'px;"><em class="pano_poi_' + recoType + '"></em>' + e + "</span></a>", 3 === recoType ? Ua() ? (
            this.Zz = b, this.BW = d, a.splice(k, 1), k--) : (b =
              '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k + '"><img style="width:' +
              (i - 2) + "px;height:" + (g - 2) + 'px;" data-index="' + k + '" name="' + e + '" src="' + c +
              '" alt="' + e +
              ...
              this.k.imageHeight + 'px;" data-index="' + k + '"><img src="' + F.qa +
              'panorama/photoexit.png" style="border:none;vertical-align:middle;" data-index="' + k +
              '" alt=""/></div></a>', f.push(b)) : f.push(b);
      return f.join("")
    },
    zX: function (a) {
      var b = this,
  ...
  Re.prototype = {
    ...
    refresh: function () {
      ...
      this.fg && (this.fg.children[0].style.marginTop = this.Ir.children[0].style.marginTop = this.fg.offsetHeight /
        2 - this.fg.children[0].offsetHeight / 2 + "px")
    },
    Ss: function () {
      return 2 * this.Ei
    },
    is: function () {
      ...
      this.fg.children[0].style.marginTop = this.Ir.children[0].style.marginTop = this.fg.offsetHeight / 2 - this
        .fg.children[0].offsetHeight / 2 + "px"
    },
    am: function () {
      var a = this;
    ...
    scrollTo: function (a) {
      a = a < this.Sg.offsetLeft ? Math.ceil((a - this.Ei - this.fo) / this.Qr) * this.Qr + this.fo + this.Ei - 8 :
